...
describe Modpanelgen::Renderer do
  it 'has a plugins method' do
    value(::Modpanelgen::Renderer).must_respond_to :plugins
  end

  describe '#plugins' do
    it 'returns an array' do
      value(::Modpanelgen::Renderer.plugins).must_be_instance_of Array
    end
  end

  it 'has a loaded_plugins method' do
    value(::Modpanelgen::Renderer).must_respond_to :loaded_plugins
  end

  describe '#loaded_plugins' do
    it 'returns an array' do
      value(::Modpanelgen::Renderer.loaded_plugins).must_be_instance_of Array
    end
  end

  it 'has a installed_plugins method' do
    value(::Modpanelgen::Renderer).must_respond_to :installed_plugins
  end

  describe '#installed_plugins' do
    it 'returns an array' do
      value(::Modpanelgen::Renderer.installed_plugins).must_be_instance_of Array
    end
  end
